...
from pandas_market_calendars.exchange_calendar_tsx import VictoriaDay

cal = mcal.get_calendar('TSX')


def test_time_zone():
    assert cal.tz == pytz.timezone('America/Toronto')
    assert cal.name == 'XTSE'
